<?php /*
Template Name: category-funny-english
*/ ?>

<?php get_header('page'); ?>

<main id="category_funny_english">
<figure class="fig main_view">
<figcaption class="figcaption">category-funny-english</figcaption>
<picture>
