<?php /*
Template Name: category-japanese-posts
*/ ?>

<?php get_header('page'); ?>

<main id="category_japanese_posts">
<figure class="fig main_view">
<figcaption class="figcaption">category-japanese-posts</figcaption>
<picture>
