...
! function (t, e) {
  ...
  var t = function (t) {
      ...
      "boolean" != typeof t.useTransform && (t.useTransform = !0), "number" != typeof t.gutter && (t.gutter = 25), t.container || e("container"), t.items || t.static || e("items or static")
    },
    e = function (t) {
    ...
    i = function (t) {
      var e = t[0];
      for (var i of t) i.height < e.height && (e = i);
      return e
    },
    n = function (e) {
  ...
  return n.prototype.init = function () {
    ...
    this.container.style.height = n + 50 + "px"
...
let magicGrid = new MagicGrid({
  ...
  gutter: 0, // Optional. Space between items. Default: 25(px). *change 25 to 0, applying style.css.
