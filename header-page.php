...
<?php elseif(is_page('location')): ?>
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/common/css/location.css">
<?php elseif(is_page('contact')): ?>
<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/common/css/contact.css">
<?php elseif(is_page('english')): ?>
