...
<link rel="preload" href="<?php echo get_stylesheet_directory_uri(); ?>/common/js/fancy_slider.js" as="script">
<link rel="preload" href="<?php echo get_stylesheet_directory_uri(); ?>/common/js/magic_grid_layout.js" as="script">
<link rel="preload" href="<?php echo get_stylesheet_directory_uri(); ?>/common/js/functions.js" as="script">
<link rel="preload" type="image/jpeg" href="<?php echo get_stylesheet_directory_uri(); ?>/common/img/fnc_aboutmike_1200x1600.jpg" as="image">
<link rel="preload" type="image/jpeg" href="<?php echo get_stylesheet_directory_uri(); ?>/common/img/fnc_one_to_one_900x1200.jpg" as="image">
<link rel="preload" type="image/jpeg" href="<?php echo get_stylesheet_directory_uri(); ?>/common/img/fnc_location_900x1280.jpg" as="image">
<link rel="preload" type="image/jpeg" href="<?php echo get_stylesheet_directory_uri(); ?>/common/img/fnc_contact_1200x800.jpg" as="image">
...
height: 100%;
transition: all 1s;
background-color: rgb(89, 145, 216);
position: fixed;
top: 0;
left: 0;
z-index: 9999;
...
<img class="logo" alt="札幌 英会話＆英語レッスン。オンラインや中央区でマンツーマンのコーチング。" width="80" height="80" loading="lazy" src="<?php echo get_stylesheet_directory_uri(); ?>/common/img/logo.svg"></a></h1>
<div class="sns">
...
<li class="category1">
<a class="nav_list" href="<?php echo home_url('reviews-cat/one-to-one'); ?>"><span class="nav_list_ja">個人レッスンレビュー</span><span class="nav_list_en Reviews_One_to_One">One to One</span></a>
</li>
<li class="category2">
<a class="nav_list" href="<?php echo home_url('reviews-cat/translations'); ?>"><span class="nav_list_ja">ネイティブ英訳レビュー</span><span class="nav_list_en Reviews_Translations">Translations</span></a>
</li>
</ul><!--drop cat_Reviews-->
<ul class="no_drop">
