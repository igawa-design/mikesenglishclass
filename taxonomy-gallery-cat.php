...
<h2 class="sec_h2 sec_h2_gallery"><em><?php echo esc_html($term->name); ?>ギャラリー</em><span><?php echo esc_html($term->slug); ?> gallery</span></h2>
<p class="sec_txt_lead gallery_lead">Photo Gallery</p>
<h3 class="sec_h3 sec_h3_02"><img class="sec_icon" alt="マイク英会話教室札幌のギャラリー" width="50" height="50" loading="lazy" src="https://igawa.co/mikesenglishclass/wp-content/themes/mikesenglishclass/common/img/icon_sec_gallery.svg"></h3>
